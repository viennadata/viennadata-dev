...
\TIP{The first pair of parenthesis always refers to the data being manipulated (either key or number of objects to be reserved), while the second pair of parenthesis always refers to the objects the data is associated with.}
...
\TIP{Always specify the key type and the data type when calling functions from {\ViennaData}}
